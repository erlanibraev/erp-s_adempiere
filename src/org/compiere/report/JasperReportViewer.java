...
public class JasperReportViewer extends JRViewer {
    ...
    public JasperReportViewer(final JasperViewer jasperViewer, final JasperPrint jasperPrint) throws JRException {
		...
		comboBox = new JComboBox( new String[] {"PDF","HTML", "XLS", "DOC"});
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (fileChooser.showSaveDialog( viewer)==JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                } else if(viewer.getFormat().equals("DOC")){
                	 JRDocxExporter exporterDoc = new JRDocxExporter();
                	 exporterDoc.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, file.getAbsolutePath());
                	 exporterDoc.setParameter(JRExporterParameter.JASPER_PRINT, viewer.getJasperPrint());
