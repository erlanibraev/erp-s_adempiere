...
//		a.nurpiisov:12012012:10:05/ update taxamount (logistic){
		BigDecimal netAmount = getLineNetAmt();  
		TaxAmt = tax.calculateTax(netAmount, isTaxIncluded(), getPrecision());
//		}
