...
/** Generated Model for erps_ContractTax
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_erps_ContractTax extends PO implements I_erps_ContractTax, I_Persistent 
{
    ...
    public X_erps_ContractTax (Properties ctx, int erps_ContractTax_ID, String trxName)
    {
      super (ctx, erps_ContractTax_ID, trxName);
      /** if (erps_ContractTax_ID == 0)
        {
			setC_Tax_ID (0);
    ...
    /** Load Constructor */
    public X_erps_ContractTax (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_erps_ContractTax[")
