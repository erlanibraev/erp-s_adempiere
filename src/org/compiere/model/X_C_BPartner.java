...
// N
	...
	/** Set BIN_IIN.
		@param BIN_IIN BIN_IIN	  */
	public void setBIN_IIN (String BIN_IIN)
	{
		set_Value (COLUMNNAME_BIN_IIN, BIN_IIN);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_BIN_IIN);
	}
	...
	/** Set Date_of_VAT.
		@param Date_of_VAT Date_of_VAT	  */
	public void setDate_of_VAT (Timestamp Date_of_VAT)
	{
		set_Value (COLUMNNAME_Date_of_VAT, Date_of_VAT);
	}

	/** Get Date_of_VAT.
		@return Date_of_VAT	  */
	public Timestamp getDate_of_VAT () 
	{
		return (Timestamp)get_Value(COLUMNNAME_Date_of_VAT);
	}
	...
	/** Set ERPS_eco_sector_code_ID.
		@param ERPS_eco_sector_code_ID 
		User who updated this records
	  */
	public void setERPS_eco_sector_code_ID (int ERPS_eco_sector_code_ID)
	{
		if (ERPS_eco_sector_code_ID < 1) 
			set_Value (COLUMNNAME_ERPS_eco_sector_code_ID, null);
		else 
			set_Value (COLUMNNAME_ERPS_eco_sector_code_ID, Integer.valueOf(ERPS_eco_sector_code_ID));
	}

	/** Get ERPS_eco_sector_code_ID.
		@return User who updated this records
	  */
	public int getERPS_eco_sector_code_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ERPS_eco_sector_code_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set erps_previousName.
		@param erps_previousName erps_previousName	  */
	public void seterps_previousName (String erps_previousName)
	{
		set_Value (COLUMNNAME_erps_previousName, erps_previousName);
	}

	/** Get erps_previousName.
		@return erps_previousName	  */
	public String geterps_previousName () 
	{
		return (String)get_Value(COLUMNNAME_erps_previousName);
	}

	/** Set erps_tableNumber.
		@param erps_tableNumber erps_tableNumber	  */
	public void seterps_tableNumber (int erps_tableNumber)
	{
		set_Value (COLUMNNAME_erps_tableNumber, Integer.valueOf(erps_tableNumber));
	}

	/** Get erps_tableNumber.
		@return erps_tableNumber	  */
	public int geterps_tableNumber () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_erps_tableNumber);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Number_of_VAT.
		@param Number_of_VAT Number_of_VAT	  */
	public void setNumber_of_VAT (String Number_of_VAT)
	{
		set_Value (COLUMNNAME_Number_of_VAT, Number_of_VAT);
	}

	/** Get Number_of_VAT.
		@return Number_of_VAT	  */
	public String getNumber_of_VAT () 
	{
		return (String)get_Value(COLUMNNAME_Number_of_VAT);
	}
	...
	{
		set_Value (COLUMNNAME_Resident, Boolean.valueOf(Resident));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_Resident);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	{
		return (String)get_Value(COLUMNNAME_RNN);
	}
	...
	/** Set Series_of_VAT.
		@param Series_of_VAT Series_of_VAT	  */
	public void setSeries_of_VAT (String Series_of_VAT)
	{
		set_Value (COLUMNNAME_Series_of_VAT, Series_of_VAT);
	}

	/** Get Series_of_VAT.
		@return Series_of_VAT	  */
	public String getSeries_of_VAT () 
	{
		return (String)get_Value(COLUMNNAME_Series_of_VAT);
	}
	 ...
	 * 	@return lines
	 */
	public MBPartner[] getPartnerEmployee (BigDecimal bpartner_id, BigDecimal department_id)
	{
		...
		String sql = "SELECT C_BPARTNER.* FROM C_BPARTNER " +
					 ...
					 "AND (HR_EMPLOYEE.ISACTIVE='Y' OR HR_EMPLOYEE.ENDDATE = TO_DATE('31.12.3333','DD.MM.YYYY')) " +
		...
		try
		{
			...
			while (rs.next ())
			{
				...
				//PO po = (PO)table.getPO(rs, get_TrxName());
				list.add(bp);
			}
		}
	 ...
	 * 	@return lines
	 */
	public MBPartner[] getPartnerEmployee (int bpartner_id, int block_id, int department_id)
	{
	...
	/**
	 * 	Bpartner (Employee) list
	 * 	@param requery
	 * 	@return lines
	 */
	public MBPartner[] getPartnerEmployee (boolean requery)
	{
		if (m_lines == null || m_lines.length == 0 || requery)
			m_lines = getPartnerEmployee(null, null);
	 ...
	 * 	@return lines
	 */
	public MBPartner[] getPartnerEmployee()
	{
		return getPartnerEmployee(false);
	}	//	getPartnerEmployee
}