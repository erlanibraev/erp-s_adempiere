...
public interface I_C_BPartner 
{
    ...
    /** Column name BIN_IIN */
    public static final String COLUMNNAME_BIN_IIN = "BIN_IIN";
    ...
    /** Column name Date_of_VAT */
    public static final String COLUMNNAME_Date_of_VAT = "Date_of_VAT";
    ...
    /** Column name ERPS_eco_sector_code_ID */
    public static final String COLUMNNAME_ERPS_eco_sector_code_ID = "ERPS_eco_sector_code_ID";
    ...
    /** Column name erps_previousName */
    public static final String COLUMNNAME_erps_previousName = "erps_previousName";
    ...
    /** Column name erps_tableNumber */
    public static final String COLUMNNAME_erps_tableNumber = "erps_tableNumber";
    ...
    /** Column name Number_of_VAT */
    public static final String COLUMNNAME_Number_of_VAT = "Number_of_VAT";
    ...
    public static final String COLUMNNAME_Resident = "Resident";
    ...
    /** Column name RNN */
    public static final String COLUMNNAME_RNN = "RNN";
    ...
    /** Column name Series_of_VAT */
    public static final String COLUMNNAME_Series_of_VAT = "Series_of_VAT";
