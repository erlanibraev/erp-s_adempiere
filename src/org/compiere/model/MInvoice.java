...
public class MInvoice extends X_C_Invoice implements DocAction
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		// Invoice upd of CashLine
		if(getC_CashLine_ID() != 0 && getC_DocTypeTarget_ID() != 0){
			String updInvoice = "UPDATE C_CashLine cl "
					+" SET C_Invoice_ID=" + getC_Invoice_ID()
					+" WHERE C_CashLine_ID=" + getC_CashLine_ID();
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
		...
		if(getC_CashLine_ID() != 0 && getC_Invoice_ID() != 0){
			String updInvoice = "UPDATE C_CashLine cl "
					+" SET C_Invoice_ID=" + getC_Invoice_ID()
					+" WHERE C_CashLine_ID=" + getC_CashLine_ID();
			DB.executeUpdate(updInvoice, get_TrxName());
