...
public final class MLookup extends Lookup implements Serializable
{
	...
	{
		//Advance statement C_invoice  (V.Sokolov)
		String winAdv = Env.getContext(Env.getCtx(), m_info.WindowNo, "CashType");
		
		if (m_info.ZoomWindowPO == 0 || query == null || Doc.CashTypeAdvance.equals(winAdv))
			return m_info.ZoomWindow;
		//	Need to check SO/PO
