...
// @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM GL_JournalLine WHERE GL_Journal_ID=@GL_Journal_ID@
	...
	/* Set ERPS_stati_BDR_ID */
	public void setERPS_stati_BDR_ID (int ERPS_stati_BDR_ID)
	{
		if (ERPS_stati_BDR_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_ERPS_stati_BDR_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_ERPS_stati_BDR_ID, Integer.valueOf(ERPS_stati_BDR_ID));
	}
	/* Set ERPS_denejnie_sredstva_ID */
	public void setERPS_denejnie_sredstva_ID (int ERPS_denejnie_sredstva_ID)
	{
		if (ERPS_denejnie_sredstva_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_ERPS_denejnie_sredstva_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_ERPS_denejnie_sredstva_ID, Integer.valueOf(ERPS_denejnie_sredstva_ID));
	}
	/* Set ERPS_stati_BDDS_ID */
	public void setERPS_stati_BDDS_ID (int ERPS_stati_BDDS_ID)
	{ 
		if (ERPS_stati_BDDS_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_ERPS_stati_BDDS_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_ERPS_stati_BDDS_ID, Integer.valueOf(ERPS_stati_BDDS_ID));
	}	
}