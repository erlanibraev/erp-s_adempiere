...
/** Generated Model for erps_contract
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_erps_contract extends PO implements I_erps_contract, I_Persistent 
{
    ...
    public X_erps_contract (Properties ctx, int erps_contract_ID, String trxName)
    {
      super (ctx, erps_contract_ID, trxName);
      /** if (erps_contract_ID == 0)
        {
			setC_Currency_ID (0);
			setCommittedAmt (Env.ZERO);
			setCommittedQty (Env.ZERO);
			seterps_contract_ID (0);
			seterps_contractType (null);
...
// -
    ...
    /** Load Constructor */
    public X_erps_contract (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_erps_contract[")
	...
	/** erps_contractType AD_Reference_ID=1000048 */
	public static final int ERPS_CONTRACTTYPE_AD_Reference_ID=1000048;
	/** Доходный = 10000011 */
	public static final String ERPS_CONTRACTTYPE_Доходный = "10000011";
	/** Расходный = 10000012 */
	public static final String ERPS_CONTRACTTYPE_Расходный = "10000012";
	/** Прочее = 10000013 */
	public static final String ERPS_CONTRACTTYPE_Прочее = "10000013";
	/** Set erps_contractType.
		@param erps_contractType erps_contractType	  */
	public void seterps_contractType (String erps_contractType)
	{

		set_Value (COLUMNNAME_erps_contractType, erps_contractType);
	}

	/** Get erps_contractType.
		@return erps_contractType	  */
	public String geterps_contractType () 
	{
		return (String)get_Value(COLUMNNAME_erps_contractType);
	}
