  ...
  */
	public void setERPS_stati_BDDS_ID (int ERPS_stati_BDDS_ID)
	{
		if (ERPS_stati_BDDS_ID < 1) 
			set_Value (COLUMNNAME_ERPS_stati_BDDS_ID, null);
		else 
			set_Value (COLUMNNAME_ERPS_stati_BDDS_ID, Integer.valueOf(ERPS_stati_BDDS_ID));
	}
	/** Set Stati_BDR.
  */
	public void setERPS_stati_BDR_ID (int ERPS_stati_BDR_ID)
	{
		if (ERPS_stati_BDR_ID < 1) 
			set_Value (COLUMNNAME_ERPS_stati_BDR_ID, null);
		else 
			set_Value (COLUMNNAME_ERPS_stati_BDR_ID, Integer.valueOf(ERPS_stati_BDR_ID));
	}
	/** Set Funds.
  */
	public void setERPS_denejnie_sredstva_ID (int ERPS_denejnie_sredstva_ID)
	{
		if (ERPS_denejnie_sredstva_ID < 1) 
			set_Value (COLUMNNAME_ERPS_denejnie_sredstva_ID, null);
		else 
			set_Value (COLUMNNAME_ERPS_denejnie_sredstva_ID, Integer.valueOf(ERPS_denejnie_sredstva_ID));
	}
