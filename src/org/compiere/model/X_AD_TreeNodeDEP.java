...
/** Generated Model for AD_TreeNodeDEP
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_AD_TreeNodeDEP extends PO implements I_AD_TreeNodeDEP, I_Persistent 
{
    ...
    public X_AD_TreeNodeDEP (Properties ctx, int AD_TreeNodeDEP_ID, String trxName)
    {
      super (ctx, AD_TreeNodeDEP_ID, trxName);
      /** if (AD_TreeNodeDEP_ID == 0)
        {
			setAD_Tree_ID (0);
			setNode_ID (0);
        } */
    ...
    /** Load Constructor */
    public X_AD_TreeNodeDEP (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_AD_TreeNodeDEP[")
