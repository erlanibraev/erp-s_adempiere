...
public interface I_GL_JournalLine 
{
    ...
    /** Column name ERPS_stati_BDR_ID */
    public static final String COLUMNNAME_ERPS_stati_BDR_ID = "ERPS_stati_BDR_ID";
    
    /** Column name ERPS_denejnie_sredstva_ID */
    public static final String COLUMNNAME_ERPS_denejnie_sredstva_ID = "ERPS_denejnie_sredstva_ID";
 
    /** Column name ERPS_stati_BDDS_ID */
    public static final String COLUMNNAME_ERPS_stati_BDDS_ID = "ERPS_stati_BDDS_ID";
