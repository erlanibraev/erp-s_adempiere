...
public class ProjectGenOrder extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		MOrder order = new MOrder (fromProject, true, MOrder.DocSubTypeSO_OnCredit);
	 	...
	 	StringBuffer sb1 = new StringBuffer (fromProject.getName());
		if (fromProject.getDescription() != null && fromProject.getDescription().length() > 0)
			sb1.append(" - ").append(fromProject.getDescription());
		ol1.setDescription(sb1.toString());
		ol1.setPrice(fromProject.getPlannedAmt());
