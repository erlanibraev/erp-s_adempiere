		...
		v_ManDep_Org = assetacct.getA_Depreciation_Manual_Amount();
		    ...
		    if (AssetSplit.getA_Asset_ID_To() == 0)
		    {
				...
				if (assetacct.getA_Depreciation_Manual_Period() == null)
					System.out.print("assetacctnew.setA_Depreciation_Manual_Period()");
				...
				if (assetacct.getA_Reval_Cal_Method() == null)
					System.out.print("change.setA_Reval_Cal_Method()");
				...
				if (assetacct.getA_Depreciation_Manual_Period() == null)
					System.out.print("change.setA_Depreciation_Manual_Period()");
			...
			if (assetacct.getA_Reval_Cal_Method() == null)
				System.out.print("change1.setA_Reval_Cal_Method()");
			...
			if (assetacct.getA_Depreciation_Manual_Period() == null)
				...
				System.out.print("change1.setA_Depreciation_Manual_Period()");
			else	
