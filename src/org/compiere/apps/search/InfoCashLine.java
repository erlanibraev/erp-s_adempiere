...
//	private VLookup fOrg_ID;
	...
	private static final Info_Column[] s_cashLayout = {
		...
		new Info_Column(Msg.translate(Env.getCtx(), "C_BPartner_ID"), "(SELECT Name FROM C_BPartner bp WHERE bp.C_BPartner_ID=c.C_BPartner_ID)", String.class),
	...
	private void statInit() throws Exception
	{
		...
		//parameterPanel.add(lCharge_ID, null);
		//parameterPanel.add(fCharge_ID, null);
		//parameterPanel.add(lBankAccount_ID, null);
		...
		parameterPanel.add(lAmtFrom, new ALayoutConstraint(2,0));
